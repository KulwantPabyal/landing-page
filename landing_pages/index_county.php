...
<html lang="en">
  <head>    
    ...
    <script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/8186697.js">
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MT5G8QZ"
    ...
    <div class="bannerMain">
        ...
        <div class="container">
            <div class="contentBox">
                ...
                <form class="form" id="step1" action="./qualify" method="post">
                    ...
                    <div class="form-input">
                        ...
                        <span class="name_error" style=" display: none">Please enter your full name.</span>
                    </div>
                    <div class="form-input">
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email"/>
                        <span class="email_error" style=" display: none">Please enter your valid email.</span>
                    </div>
                    <div class="form-input">
                      
                      
                           <div class="column" id="country">
                        <input type="text"  name="countryCode" id="countrycode" class="form-control" placeholder="+1"   value="" required />
          
                        <span class="country_error" style="display: none">Please Enter countrycode.</span>
                      </div>
                      <div class="column" id="tele">
                         <input type="text"  name="tel" id="tel" class="form-control" placeholder="9874535262"   value="" required />
          
                        <span class="tel_error" style=" display: none">Please enter valid number.</span>
                      </div>

                    <input type="text" name="phoneNumber" class="form-control emailOpacity" id="phoneNumber" value="" />
                    ...
                    <div class="form-input-action">
                        <input type="submit" id="submit1" name="submit1" class="submit-btn btn-green" Value="Go To Step 2" />
        ...
        <div class="container">
            <div class="glen__content">
                ...
                <div class="glen__videoBox">
                    <iframe class="lazy" width="700" height="400" src="https://www.youtube.com/embed/tfvU4aal5qA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="session_Steps">
                <div class="row">
                    <div class="col-12 col-ms-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="imagesSec lazy"   style="background-image: url(images/dan-rose.png);">
...
<script type="text/javascript">
  ...
  <noscript>
  <img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=2954988&fmt=gif" />
</noscript>
  ...
  <!-- <script>
    ...
    <script type="text/javascript">
      $(".zencydash-page-sidebar-list ul li a").each(function() {   
          if (this.href == window.location.href) {
             $(".zencydash-page-sidebar-list ul li a").removeClass("active") && $(this).addClass("active");
          }
        });
    </script>
 -->    
...
$(document).ready(function(e){	
  $("#tel").keyup(function(){  
          ...
          var finalNumber = $("#phoneNumber").val(countryCode + tel);     
